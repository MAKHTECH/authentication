...
func (r *Repository) SaveUser(ctx context.Context, email, username, passHash string) (int64, error) {
	const op string = "repository.postgres.SaveUser"
...
func (r *Repository) SaveTelegramUser(ctx context.Context, telegramID int64, username, firstName, lastName, photoURL string) (int64, error) {
	const op string = "repository.postgres.SaveTelegramUser"
...
func (r *Repository) UserByTelegramID(ctx context.Context, telegramID int64, appID int) (*models.User, error) {
	const op string = "repository.postgres.UserByTelegramID"
	...
	row := r.db.QueryRowContext(ctx, query, appID, telegramID)
	return r.scanUser(row, op)
}
...
func (r *Repository) UpdateTelegramUser(ctx context.Context, telegramID int64, username, firstName, lastName, photoURL string) error {
	const op string = "repository.postgres.UpdateTelegramUser"
...
func (r *Repository) User(ctx context.Context, username string, appID int) (*models.User, error) {
	const op string = "repository.postgres.User"
...
func (r *Repository) scanUser(row *sql.Row, op string) (*models.User, error) {
